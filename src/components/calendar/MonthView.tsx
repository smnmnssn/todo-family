        ...
        <div className="glass-surface p-4 md:p-6">
          ...
          <div className="grid grid-cols-7 gap-1 sm:gap-2 text-sm">
            {cells.map((cell) => {
              ...
              const shouldBeRed =
                cell.inCurrentMonth && (isWeekend || isHoliday);
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    isSelected &&
                      "border-white/60 ring-2 ring-sky-500/25 bg-white/25",
                ...
                >
                  <div className="flex w-full items-center justify-between">
                    <span
                      className={cn(
                        shouldBeRed && "text-red-600 font-semibold"
                      )}
                    ...
                    {isToday && (
                      <span className="hidden sm:inline rounded-full bg-[#8FAEC9]/20 px-1.5 py-0.5 text-[10px] font-medium text-[#567A98]">
                        Idag
                      </span>
                    )}
                  </div>
          ...
          {selectedActivities.length === 0 ? (
            ...
            <ul className="space-y-2 text-sm">
              {selectedActivities.map((activity) => (
                ...
                >
                  <div className="space-y-0.5">
                    <p className="font-medium text-[#3b4a5c]">
                      {activity.title}
                    </p>
